...
DEFAULT_WORKFLOW = {
    ...
    "steps": [
        ...
        {"id": "outline", "needs": "故事结构", "prompt": "根据立意设计完整的故事大纲。本书目标写{target_chapters}章，请将故事分为多个阶段（开篇铺垫、前期发展、中期推进、后期高潮、收束终章），每个阶段标注起止章节和核心剧情。\n\n大纲必须包含以下内容：\n1. 整体故事结构和阶段划分\n2. 主线剧情脉络和关键转折点（标注对应章节范围）\n3. 支线剧情设计和与主线的交汇点\n4. 故事时间线（关键事件和对应章节）\n5. 核心冲突的升级节奏\n\n大纲要足够详细，能支撑{target_chapters}章的篇幅，避免剧情在前100章就走完。", "input": ["planning/立意.md"], "output": "planning/大纲.md"},
        ...
        {"id": "chapter", "needs": "正文写作", "prompt": "根据大纲、世界观、人物设定和前文写第{n}章正文。严格遵守【写作约束·角色锚定】中的规则：主角不得更换，角色名不得擅改，新人物不得无铺垫登场。参考【灵感】和【角色推演】来推进剧情。保持与前文连贯。", "input": ["planning/大纲.md", "planning/人物设定.md", "planning/世界观.md", "planning/伏笔.md", "prev_chapters"], "output": "chapters/{n}_chapter.txt"},
