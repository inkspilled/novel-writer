...
STRINGS = {
    ...
    "workflow_generate": {"zh": "AI 生成工作流", "en": "AI Generate Workflow"},
    ...
    "workflow_generating": {"zh": "AI 正在生成工作流...", "en": "AI generating workflow..."},
    "workflow_generated": {"zh": "工作流已生成", "en": "Workflow generated"},
    "workflow_gen_fail": {"zh": "生成工作流失败: {}", "en": "Failed to generate workflow: {}"},
